...
# However, using OE thud, quick experiments have shown that it's possible to use up to CEIL(<RAM-in-GB>/5) as the argument to -j
# without running out of memory as long as the machine has a few GB of swap space. If this fails, override it by setting
