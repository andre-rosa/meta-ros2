...
ROS_COMPONENT_TYPE = "${@ros_common__get_component_type('dynamixel-workbench-msgs', d)}"

# Allow the above settings to be overridden.
ROS_RECIPES_TREE := "${@ros_superflore_generated__get_recipes_tree('dynamixel-workbench-msgs', d)}"
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/dynamixel-workbench-msgs/dynamixel-workbench-msgs_common.inc
