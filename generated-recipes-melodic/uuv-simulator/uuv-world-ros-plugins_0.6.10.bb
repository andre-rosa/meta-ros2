...
SRC_URI = "https://github.com/uuvsimulator/uuv_simulator-release/archive/release/melodic/uuv_world_ros_plugins/0.6.10-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
