...
SRC_URI = "https://github.com/DataspeedInc-release/dbw_fca_ros-release/archive/release/melodic/dbw_fca_joystick_demo/1.0.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
