...
SRC_URI = "https://github.com/gt-rail-release/rail_manipulation_msgs-release/archive/release/melodic/rail_manipulation_msgs/0.0.12-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
