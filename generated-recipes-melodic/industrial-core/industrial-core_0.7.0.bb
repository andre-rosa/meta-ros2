...
SRC_URI = "https://github.com/ros-industrial-release/industrial_core-release/archive/release/melodic/industrial_core/0.7.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
