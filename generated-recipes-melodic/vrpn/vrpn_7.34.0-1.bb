...
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/vrpn/vrpn_common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/vrpn/vrpn-${PV}_common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/vrpn/${BPN}.inc
