...
SRC_URI = "https://github.com/pr2-gbp/pr2_controllers-release/archive/release/melodic/pr2_mechanism_controllers/1.10.15-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
