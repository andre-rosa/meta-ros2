...
SRC_URI = "https://github.com/fetchrobotics-gbp/fetch_gazebo-release/archive/release/melodic/fetch_simulation/0.9.1-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
