...
include ${ROS_LAYERDIR}/recipes-ros/panda-moveit-config/panda-moveit-config_common.inc
include ${ROS_LAYERDIR}/recipes-ros2/panda-moveit-config/panda-moveit-config_common.inc
