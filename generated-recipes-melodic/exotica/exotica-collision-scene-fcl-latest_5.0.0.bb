...
SRC_URI = "https://github.com/ipab-slmc/exotica-release/archive/release/melodic/exotica_collision_scene_fcl_latest/5.0.0-0.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
