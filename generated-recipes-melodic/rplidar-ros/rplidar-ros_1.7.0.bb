...
ROS_COMPONENT_TYPE = "${@ros_common__get_component_type('rplidar-ros', d)}"

# Allow the above settings to be overridden.
ROS_RECIPES_TREE := "${@ros_superflore_generated__get_recipes_tree('rplidar-ros', d)}"
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rplidar-ros/rplidar-ros_common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rplidar-ros/rplidar-ros-${PV}_common.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rplidar-ros/${BPN}.inc
include ${ROS_LAYERDIR}/${ROS_RECIPES_TREE}/rplidar-ros/${BPN}-${PV}.inc
