...
SRC_URI = "https://github.com/pr2-gbp/pr2_simulator-release/archive/release/melodic/pr2_controller_configuration_gazebo/2.0.13-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b3fc38aee4b63269893d928d3e41166c"
SRC_URI[sha256sum] = "10d2c152c70184c94fdf0ced97bbeb8e8ff414c31a28e036fd4e2a3ae717a511"
S = "${WORKDIR}/pr2_simulator-release-release-melodic-pr2_controller_configuration_gazebo-2.0.13-1"
