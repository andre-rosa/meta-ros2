...
SRC_URI = "https://github.com/ros2-gbp/ros2_object_analytics-release/archive/release/dashing/object_analytics_msgs/0.5.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b259c0ea50159669267726fb56dfb7e5"
SRC_URI[sha256sum] = "66c9362495ccfb43015f28e9163971aed2d1a5c0a4dc6d948a6f5fea76fd75fa"
S = "${WORKDIR}/ros2_object_analytics-release-release-dashing-object_analytics_msgs-0.5.4-1"
