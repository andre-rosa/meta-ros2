...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclcpp_minimal_publisher/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5b92ce5ece9cd130daef481081a78b79"
SRC_URI[sha256sum] = "72434a56f3b74b7dc3e99c44375bf283bc5dabd4b17645b4c75d656e2042dbcf"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclcpp_minimal_publisher-0.7.2-1"
