...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclpy_minimal_action_server/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "32a78dc14a3fcf50d1ec807b8215929e"
SRC_URI[sha256sum] = "122aff75ccf6f8bfa38445d13b8616855df318b6f2e1f16e7115a50d251ada07"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclpy_minimal_action_server-0.7.2-1"
