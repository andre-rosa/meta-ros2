...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclcpp_minimal_subscriber/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "dd2222a7803e2a0643bd0997a6fa08aa"
SRC_URI[sha256sum] = "f6dc1d3dd1ffc61621121a657ea009853fb3e36b06f3b8950ac94e452a5781e3"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclcpp_minimal_subscriber-0.7.2-1"
