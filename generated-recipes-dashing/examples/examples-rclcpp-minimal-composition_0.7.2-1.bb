...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclcpp_minimal_composition/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3354678221e31c08ba66339fd1c34d2a"
SRC_URI[sha256sum] = "c1eba2ac89f993d3fd5b16f06bdafbeab90e3e9a25f207910dc8eef9f2796819"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclcpp_minimal_composition-0.7.2-1"
