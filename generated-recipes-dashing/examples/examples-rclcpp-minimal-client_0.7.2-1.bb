...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclcpp_minimal_client/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "dfc14ce8c641a7d5fe07d908e5b23ed0"
SRC_URI[sha256sum] = "e70924c85f67c0db6b1d6d11595a42d5e0b0d31d48ead9f1414eed889247522a"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclcpp_minimal_client-0.7.2-1"
