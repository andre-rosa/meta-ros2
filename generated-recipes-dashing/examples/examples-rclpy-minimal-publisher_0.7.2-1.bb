...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclpy_minimal_publisher/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a2c9d8b3437dee1d19c0a088cdf2970b"
SRC_URI[sha256sum] = "9cc1c932a3dde9f33db3b43e561405a4e3a5130ea64a50a09d19b90e8033f745"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclpy_minimal_publisher-0.7.2-1"
