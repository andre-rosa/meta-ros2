...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclcpp_minimal_publisher/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "6d5dedc86f74e01ac797e9a55807ef59"
SRC_URI[sha256sum] = "0838646d865728f2a8cf3d7f04ef3a6a2d129dc625579fbdc69e9b2e097f5c44"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclcpp_minimal_publisher-0.7.1-1"
