...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclpy_executors/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c9fe173289b7ef93528cfd111dec55ea"
SRC_URI[sha256sum] = "cd22e9997ad4a69643b45d3e1fee21022def477af9c965b768c5ef9d98ac1ce3"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclpy_executors-0.7.1-1"
