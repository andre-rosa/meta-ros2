...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclpy_executors/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "60b393230cafe9c445042fe8ee866d0c"
SRC_URI[sha256sum] = "bece286a94fcc7bf6a71607250e830a1740e9d622c377bf4815eb48b6284ba4d"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclpy_executors-0.7.2-1"
