...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/dashing/examples_rclpy_minimal_service/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8e72e7909d7d3dd6a175d1bd111f93dd"
SRC_URI[sha256sum] = "b380ce567dce8759acd1bd9748cd8ad81eed661b0fcf58df6debeb360cad8410"
S = "${WORKDIR}/examples-release-release-dashing-examples_rclpy_minimal_service-0.7.2-1"
