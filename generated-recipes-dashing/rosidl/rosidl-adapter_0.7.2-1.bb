...
SRC_URI = "https://github.com/ros2-gbp/rosidl-release/archive/release/dashing/rosidl_adapter/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "67a82db88e23180d60ff1eb05239044a"
SRC_URI[sha256sum] = "b8bcd8ed7e0251a57b2aed3c1ab2d8d7717e0170726e1a87513995ea47fb862c"
S = "${WORKDIR}/rosidl-release-release-dashing-rosidl_adapter-0.7.2-1"
