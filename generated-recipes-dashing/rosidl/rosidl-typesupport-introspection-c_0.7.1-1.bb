...
SRC_URI = "https://github.com/ros2-gbp/rosidl-release/archive/release/dashing/rosidl_typesupport_introspection_c/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "ed93e6f12bf5570b7e69f6c08aa9fb87"
SRC_URI[sha256sum] = "317d754ef1bd5e20a178161cfbbfb36f973b67e7114404190630bdfb9ff27ecf"
S = "${WORKDIR}/rosidl-release-release-dashing-rosidl_typesupport_introspection_c-0.7.1-1"
