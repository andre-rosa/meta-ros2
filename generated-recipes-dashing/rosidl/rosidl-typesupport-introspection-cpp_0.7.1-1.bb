...
SRC_URI = "https://github.com/ros2-gbp/rosidl-release/archive/release/dashing/rosidl_typesupport_introspection_cpp/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2b36a1ff8d9d343ea38454d79f80bf15"
SRC_URI[sha256sum] = "062295049a3980ee4c67077209fab034379f92edadebda73fff23f014e99a95d"
S = "${WORKDIR}/rosidl-release-release-dashing-rosidl_typesupport_introspection_cpp-0.7.1-1"
