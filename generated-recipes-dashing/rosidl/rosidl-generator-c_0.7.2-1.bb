...
SRC_URI = "https://github.com/ros2-gbp/rosidl-release/archive/release/dashing/rosidl_generator_c/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f75444369567a855900c34acf1fe6aa0"
SRC_URI[sha256sum] = "83bd0cf876a71f6592dd12ec32205628e2053cbb0cb6294c271f3952a461a262"
S = "${WORKDIR}/rosidl-release-release-dashing-rosidl_generator_c-0.7.2-1"
