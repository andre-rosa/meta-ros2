...
SRC_URI = "https://github.com/ros2-gbp/rosidl-release/archive/release/dashing/rosidl_cmake/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "909a4cff31a5ac3b4bd6c63acaae2d04"
SRC_URI[sha256sum] = "cc7421018a5c49ebdc9c2154e9e0c64699baa926c9eaa34052ebcea550edbbde"
S = "${WORKDIR}/rosidl-release-release-dashing-rosidl_cmake-0.7.1-1"
