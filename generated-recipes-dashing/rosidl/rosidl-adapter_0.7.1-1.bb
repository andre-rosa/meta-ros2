...
SRC_URI = "https://github.com/ros2-gbp/rosidl-release/archive/release/dashing/rosidl_adapter/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2f32fd1b3f0209ae19e45398c4119eb0"
SRC_URI[sha256sum] = "eae489b4cc927662b7bd9e8016deda4a73920649dce16365fc524b96502a85ec"
S = "${WORKDIR}/rosidl-release-release-dashing-rosidl_adapter-0.7.1-1"
