...
SRC_URI = "https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz_common/6.0.0-2.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5507a4601f940ba5acef759a78990ee1"
SRC_URI[sha256sum] = "2fe85156f94a1732a271a7b3ce1884c847b3dca6371a259a7a6bcf8e02d4bd4c"
S = "${WORKDIR}/rviz-release-release-dashing-rviz_common-6.0.0-2"
