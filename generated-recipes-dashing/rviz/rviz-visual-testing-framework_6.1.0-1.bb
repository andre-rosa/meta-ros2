...
SRC_URI = "https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz_visual_testing_framework/6.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e1664d5e25c3ae333d39ae1bfd07ce5d"
SRC_URI[sha256sum] = "5f8d9bbbb44681320d774ed44ade51d7526acff723e7ba59d99b41493a46ad32"
S = "${WORKDIR}/rviz-release-release-dashing-rviz_visual_testing_framework-6.1.0-1"
