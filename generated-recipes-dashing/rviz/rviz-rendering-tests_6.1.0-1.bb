...
SRC_URI = "https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz_rendering_tests/6.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "afb5d2a8367c64ba919575b7cb729852"
SRC_URI[sha256sum] = "65964641043b546742f28311ea105981daa04de5cac2f0fe97fcacde406f04df"
S = "${WORKDIR}/rviz-release-release-dashing-rviz_rendering_tests-6.1.0-1"
