...
SRC_URI = "https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz_assimp_vendor/6.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4194aa4345a02be8e0777c2a40861b13"
SRC_URI[sha256sum] = "965f9c54932a168cf20bc745894609960bbf74d0cfc127974f59d3aeca13ebed"
S = "${WORKDIR}/rviz-release-release-dashing-rviz_assimp_vendor-6.1.0-1"
