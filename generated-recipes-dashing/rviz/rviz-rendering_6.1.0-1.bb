...
SRC_URI = "https://github.com/ros2-gbp/rviz-release/archive/release/dashing/rviz_rendering/6.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9916721668efb4dc249e0df33ee8f6dc"
SRC_URI[sha256sum] = "cc80622dc3d1437dad0f66dddcc100452a7cbaf1cc9600f27c7c1b3938ea1b03"
S = "${WORKDIR}/rviz-release-release-dashing-rviz_rendering-6.1.0-1"
