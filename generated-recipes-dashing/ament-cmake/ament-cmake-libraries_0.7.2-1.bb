...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_libraries/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "105adadffb32d763d415f56eaec38edb"
SRC_URI[sha256sum] = "7298df122da5b566c93c52f31002ddce4b2251ffa38ebea340633b1b6bbe3f71"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_libraries-0.7.2-1"
