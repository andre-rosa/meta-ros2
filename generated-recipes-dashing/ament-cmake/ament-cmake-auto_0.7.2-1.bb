...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_auto/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "0b3f018cbfa8051a4b06983976ccdcef"
SRC_URI[sha256sum] = "077ec6c2e10af6c2776dfebbf3e9c6e07ee33abd6e49b34ff682c522ea30d8e2"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_auto-0.7.2-1"
