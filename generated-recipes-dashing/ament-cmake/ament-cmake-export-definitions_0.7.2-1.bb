...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_export_definitions/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e87c5587aa4ed6b8551b29605176acb3"
SRC_URI[sha256sum] = "71487f094a3707036d6a58c71ceeba7bbbe2ac108e06ada26a40ec12dc192ed0"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_export_definitions-0.7.2-1"
