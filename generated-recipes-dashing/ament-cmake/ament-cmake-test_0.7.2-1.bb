...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_test/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c7aba4ff44d1c90e3a79f9f118f0ec10"
SRC_URI[sha256sum] = "ebbafdbfe4906fe04d392475eb1adb1fa481bf033166e8952fb43822a8f6d49e"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_test-0.7.2-1"
