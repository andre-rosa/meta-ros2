...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_export_link_flags/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "43512ddba21b62510205f1278696a7df"
SRC_URI[sha256sum] = "1057ff1791a08b14f1e6b6cd6aa13ed5697c55170ae9f6b19db4b237779c9e25"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_export_link_flags-0.7.1-1"
