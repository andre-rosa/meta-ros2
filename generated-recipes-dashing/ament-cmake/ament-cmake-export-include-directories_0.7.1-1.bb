...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_export_include_directories/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "20add6568a37eb3ad51d2d4c83c94bae"
SRC_URI[sha256sum] = "1e37efcf6d5beb998385acbcfcce3d460f07a2919c83c430d091192e5579ca87"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_export_include_directories-0.7.1-1"
