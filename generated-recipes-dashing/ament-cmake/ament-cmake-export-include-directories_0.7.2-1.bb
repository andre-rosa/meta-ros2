...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_export_include_directories/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "09a3b587f87306ac5a0b1c21c9a24930"
SRC_URI[sha256sum] = "ce5b51d0e403e5e8db1a27262faf5e1767f15250c76ca8f83179db71dd206ed8"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_export_include_directories-0.7.2-1"
