...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_gtest/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2ca31632de86fdcae38edc84d6c5d2c0"
SRC_URI[sha256sum] = "763a53c53464c4034a0264d00830948146cf125605d784df7d4776096bfdd3a1"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_gtest-0.7.2-1"
