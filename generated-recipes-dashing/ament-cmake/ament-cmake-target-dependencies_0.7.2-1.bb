...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_target_dependencies/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "dd52cead2c565cb71427b67962aa1010"
SRC_URI[sha256sum] = "ab55e079438002899b4c3677d8c79cb7389ce132b218ed648a8423a0873cbc76"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_target_dependencies-0.7.2-1"
