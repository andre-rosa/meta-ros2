...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_export_libraries/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "bfd67673373cea0b95cabd8926c59833"
SRC_URI[sha256sum] = "e83f94b64b0ac601ac408c50195f416700dbe3ebc5c4e5d4f5be85be2bfe5e56"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_export_libraries-0.7.2-1"
