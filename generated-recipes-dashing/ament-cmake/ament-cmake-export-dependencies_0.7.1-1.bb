...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_export_dependencies/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "167880a4905c868b36e33b6dba1fc7d6"
SRC_URI[sha256sum] = "fba4b81db75207aa316137fbd52425eb52de633c4d43d62c7a03938210e51a55"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_export_dependencies-0.7.1-1"
