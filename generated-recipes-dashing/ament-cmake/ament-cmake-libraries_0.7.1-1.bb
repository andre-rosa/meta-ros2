...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_libraries/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "31668203bebe8b30db3ec5be1a865aca"
SRC_URI[sha256sum] = "92b38c538a7c9ccbe6cbbd233f5ee1db75bfbdcaddad6cd42720e0aebfbe95da"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_libraries-0.7.1-1"
