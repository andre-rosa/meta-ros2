...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_core/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3fa65ee26b26d616597176a60b8cec32"
SRC_URI[sha256sum] = "1b63902039ec00b587c8565455dff92004a0a8b66d2d13d941a70d36814384fe"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_core-0.7.1-1"
