...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_target_dependencies/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "00a401b7c2acadd152deb700dbefbb8d"
SRC_URI[sha256sum] = "1f4c654e1f718b5a865cb1a70e5a23aa8ea224a1788733bbab7fccde4c8254ee"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_target_dependencies-0.7.1-1"
