...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/dashing/ament_cmake_include_directories/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "55df8d48386e325f2fcd14068121d25c"
SRC_URI[sha256sum] = "59f7a5a188475bd2c3160e707bf795c9d57639aec2fc8084af3cab512370e69e"
S = "${WORKDIR}/ament_cmake-release-release-dashing-ament_cmake_include_directories-0.7.2-1"
