...
SRC_URI = "https://github.com/ros2-gbp/rclpy-release/archive/release/dashing/rclpy/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f70dce406af2d00e254ee79b93ad47a0"
SRC_URI[sha256sum] = "05ef2dac6d7229769c88d31a52aa6bccd4855f6f5975fd1c28f94d8d034bda00"
S = "${WORKDIR}/rclpy-release-release-dashing-rclpy-0.7.1-1"
