...
SRC_URI = "https://github.com/ros2-gbp/demos-release/archive/release/dashing/dummy_map_server/0.7.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9901f230567046b69f7e666c5170eefc"
SRC_URI[sha256sum] = "bff1b0758d606463a09a1e159e2dd81bab9c979c8cbce2c0a9d5eb1a60a9592e"
S = "${WORKDIR}/demos-release-release-dashing-dummy_map_server-0.7.4-1"
