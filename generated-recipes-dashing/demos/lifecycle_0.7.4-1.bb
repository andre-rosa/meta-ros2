...
SRC_URI = "https://github.com/ros2-gbp/demos-release/archive/release/dashing/lifecycle/0.7.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2ac8ecad4753936f9cf58f4dbd8eb602"
SRC_URI[sha256sum] = "d9ed3f73f8d265db5f42dc6b8f515dccfd9e31d1d0d12e7b203b898765f3833f"
S = "${WORKDIR}/demos-release-release-dashing-lifecycle-0.7.4-1"
