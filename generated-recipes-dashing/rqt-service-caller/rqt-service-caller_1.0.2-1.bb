...
SRC_URI = "https://github.com/ros2-gbp/rqt_service_caller-release/archive/release/dashing/rqt_service_caller/1.0.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "efdfed748b3a213b21cba23a57c2355f"
SRC_URI[sha256sum] = "2891c4dc5889aaa4af9372e2e2072c5fc5d30ce2f791d3440260ea06dd02b7ec"
S = "${WORKDIR}/rqt_service_caller-release-release-dashing-rqt_service_caller-1.0.2-1"
