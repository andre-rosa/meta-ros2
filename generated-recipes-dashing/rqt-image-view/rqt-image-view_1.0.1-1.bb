...
SRC_URI = "https://github.com/ros2-gbp/rqt_image_view-release/archive/release/dashing/rqt_image_view/1.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "07791a63e3844bdf9db77d55cfd0ed54"
SRC_URI[sha256sum] = "fdad162ed2d4ec0b0eb78dfda0773243fd0421cebafb443e9d082b262c43e4a8"
S = "${WORKDIR}/rqt_image_view-release-release-dashing-rqt_image_view-1.0.1-1"
