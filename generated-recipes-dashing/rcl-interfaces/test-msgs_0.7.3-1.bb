...
SRC_URI = "https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/dashing/test_msgs/0.7.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a45115198cd5cd8a8b2a8e762ad64677"
SRC_URI[sha256sum] = "9ddf707bc3d8afc0d4427f1995e44490c800d2e76d019624da16ea7e15b07ea6"
S = "${WORKDIR}/rcl_interfaces-release-release-dashing-test_msgs-0.7.3-1"
