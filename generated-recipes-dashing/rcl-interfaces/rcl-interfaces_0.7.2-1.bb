...
SRC_URI = "https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/dashing/rcl_interfaces/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "62360cd91d08825bcea1c57bf6a92a7b"
SRC_URI[sha256sum] = "babe59c6d2857637c7c13bb6c70ae9bfa8b85b0b685838fccde5c5608f4cd370"
S = "${WORKDIR}/rcl_interfaces-release-release-dashing-rcl_interfaces-0.7.2-1"
