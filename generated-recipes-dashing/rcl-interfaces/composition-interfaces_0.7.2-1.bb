...
SRC_URI = "https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/dashing/composition_interfaces/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "63196679413f04fafdbb369b88300422"
SRC_URI[sha256sum] = "ebaf3e13888d64a235d5f72ac0e19d2ccdce1f6bccb70eb5155afea07582b28d"
S = "${WORKDIR}/rcl_interfaces-release-release-dashing-composition_interfaces-0.7.2-1"
