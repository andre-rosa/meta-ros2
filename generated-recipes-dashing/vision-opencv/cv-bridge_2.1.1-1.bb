...
SRC_URI = "https://github.com/ros2-gbp/vision_opencv-release/archive/release/dashing/cv_bridge/2.1.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c0a246cb3f27ee0485c4cb947793c40a"
SRC_URI[sha256sum] = "9c25e327957be8d806642e3056bcd966924cbe9a0ae0e2a64d251ba1e3eaeb44"
S = "${WORKDIR}/vision_opencv-release-release-dashing-cv_bridge-2.1.1-1"
