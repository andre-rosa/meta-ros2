...
SRC_URI = "https://github.com/ros2-gbp/launch-release/archive/release/dashing/launch_testing_ament_cmake/0.8.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "98ea0efd03c2e14f960dae78c73e5e18"
SRC_URI[sha256sum] = "629162c3872253cbf037bee0b0fac179b35c2563e2832c25d4668d74935d5d52"
S = "${WORKDIR}/launch-release-release-dashing-launch_testing_ament_cmake-0.8.2-1"
