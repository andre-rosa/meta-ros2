...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/dashing/ament_cmake_clang_format/0.7.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4f4708a916534a23b98a3307e7f9db20"
SRC_URI[sha256sum] = "c85803423812cb82b126b3e4b4447d5e89e1d58f1a385c9cd937436ec11791e1"
S = "${WORKDIR}/ament_lint-release-release-dashing-ament_cmake_clang_format-0.7.3-1"
