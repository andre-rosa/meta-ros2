...
SRC_URI = "https://github.com/ros2-gbp/ros2cli-release/archive/release/dashing/ros2run/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7d6636d666c558faf8c3a8b8c273ab53"
SRC_URI[sha256sum] = "c436d5be88abd4db36b47fde3892994eff942a42c23c5ad9ecca2c8532c5d106"
S = "${WORKDIR}/ros2cli-release-release-dashing-ros2run-0.7.2-1"
