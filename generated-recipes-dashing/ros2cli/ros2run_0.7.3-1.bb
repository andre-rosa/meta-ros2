...
SRC_URI = "https://github.com/ros2-gbp/ros2cli-release/archive/release/dashing/ros2run/0.7.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f568ce4739b29c0ee37ac9663042e40d"
SRC_URI[sha256sum] = "d11046b2cd6cd13769dee34c6c1fe254a755cd7f9a60152ff0bbf0dcebf24b37"
S = "${WORKDIR}/ros2cli-release-release-dashing-ros2run-0.7.3-1"
