...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/rosbag2_storage/0.1.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "777d0376efddc958ddd83c7cedc07aa5"
SRC_URI[sha256sum] = "25bfe5b35eb6fef5fd92f01d9031d2c2a9c78a725fab3bb0b8a36d9d84b3b223"
S = "${WORKDIR}/rosbag2-release-release-dashing-rosbag2_storage-0.1.1-1"
