...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/rosbag2_test_common/0.1.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "089d4c30c6cd9f9117c743ffc7adaa13"
SRC_URI[sha256sum] = "81ee81d0e077c121ec5873fafba65d4be152db0e5afa495386102c7a968f187f"
S = "${WORKDIR}/rosbag2-release-release-dashing-rosbag2_test_common-0.1.1-1"
