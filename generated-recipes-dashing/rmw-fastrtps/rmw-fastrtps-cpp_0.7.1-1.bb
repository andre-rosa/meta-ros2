...
SRC_URI = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/dashing/rmw_fastrtps_cpp/0.7.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f95b3ca8bd5ea6258c7ec1d050fd3e6c"
SRC_URI[sha256sum] = "85492ad87423da2ca37edfe74c24657102154618885e91f142448b773adee82f"
S = "${WORKDIR}/rmw_fastrtps-release-release-dashing-rmw_fastrtps_cpp-0.7.1-1"
