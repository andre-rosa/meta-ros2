...
SRC_URI = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/dashing/rmw_fastrtps_cpp/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1b8ad3272ecab34d9e5db9b8bd627751"
SRC_URI[sha256sum] = "8c086788a0449a95ffa7a8b6a6827d5a8bc8268b7822d78d559c708036331d94"
S = "${WORKDIR}/rmw_fastrtps-release-release-dashing-rmw_fastrtps_cpp-0.7.2-1"
