...
SRC_URI = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/dashing/rmw_fastrtps_dynamic_cpp/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "555da92f9ee5b3baaae2d3d0fa021850"
SRC_URI[sha256sum] = "a38e1541acf5e1dc50b8a680fe91896e9dcea14dd7e67b58a9ca9b29fa5344bc"
S = "${WORKDIR}/rmw_fastrtps-release-release-dashing-rmw_fastrtps_dynamic_cpp-0.7.2-1"
