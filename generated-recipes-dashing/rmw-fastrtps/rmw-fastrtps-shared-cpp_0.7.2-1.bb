...
SRC_URI = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/dashing/rmw_fastrtps_shared_cpp/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "0cd71f9a6a3e06bb110b7a92bb00a9b8"
SRC_URI[sha256sum] = "68fba34d9b14896dba26558fc206d22c94330e8af1ca5164daead7175057d7ef"
S = "${WORKDIR}/rmw_fastrtps-release-release-dashing-rmw_fastrtps_shared_cpp-0.7.2-1"
