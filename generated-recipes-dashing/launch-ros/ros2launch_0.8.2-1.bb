...
SRC_URI = "https://github.com/ros2-gbp/launch_ros-release/archive/release/dashing/ros2launch/0.8.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "9dc12cf12a7625418ed6a914310ea5d2"
SRC_URI[sha256sum] = "10f06f64b2dd4815e96b8eb915a1ab3eb54b6ddc2838f39ceb0fb1b3e88ca351"
S = "${WORKDIR}/launch_ros-release-release-dashing-ros2launch-0.8.2-1"
