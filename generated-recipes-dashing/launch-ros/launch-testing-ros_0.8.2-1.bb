...
SRC_URI = "https://github.com/ros2-gbp/launch_ros-release/archive/release/dashing/launch_testing_ros/0.8.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a7bebc800b6bd63348e80136a39e9566"
SRC_URI[sha256sum] = "ccaafacae50d6c3e286e1a0d11957694982046589a3f151432052cb9d7461a08"
S = "${WORKDIR}/launch_ros-release-release-dashing-launch_testing_ros-0.8.2-1"
