...
SRC_URI = "https://github.com/ros2-gbp/osrf_testings_tools_cpp-release/archive/release/dashing/osrf_testing_tools_cpp/1.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f4e279e5834f29300230d9d6df717ca4"
SRC_URI[sha256sum] = "9a4a6388008cda4e1e8ae53cdbee56442e5dcb8d1e2e2d9e901af82f150e8421"
S = "${WORKDIR}/osrf_testings_tools_cpp-release-release-dashing-osrf_testing_tools_cpp-1.2.0-1"
