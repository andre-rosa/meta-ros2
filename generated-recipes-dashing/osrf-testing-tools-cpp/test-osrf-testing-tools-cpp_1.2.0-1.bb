...
SRC_URI = "https://github.com/ros2-gbp/osrf_testings_tools_cpp-release/archive/release/dashing/test_osrf_testing_tools_cpp/1.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8c79ea91f879566e8a2fb2c735cc8e4b"
SRC_URI[sha256sum] = "edd431c925be1902789379c3528af231281fa6796abec4a66b8fe98091808b1b"
S = "${WORKDIR}/osrf_testings_tools_cpp-release-release-dashing-test_osrf_testing_tools_cpp-1.2.0-1"
