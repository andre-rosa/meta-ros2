...
SRC_URI = "https://github.com/ros2-gbp/image_common-release/archive/release/dashing/camera_calibration_parsers/2.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "6400215df92bf3726e425f69c6334701"
SRC_URI[sha256sum] = "e2d88c79c4fcf1148466764c7d51ac34d6e2c43fd8405f939638475755647539"
S = "${WORKDIR}/image_common-release-release-dashing-camera_calibration_parsers-2.1.0-1"
