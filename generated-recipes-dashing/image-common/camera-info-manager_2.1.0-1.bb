...
SRC_URI = "https://github.com/ros2-gbp/image_common-release/archive/release/dashing/camera_info_manager/2.1.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4f6fdbcbb91eb886f912c7a87ae93dad"
SRC_URI[sha256sum] = "84b3ee22c02796db6bf80858a7ca57e67e6dd6efef367ecf1995612c5cc2da95"
S = "${WORKDIR}/image_common-release-release-dashing-camera_info_manager-2.1.0-1"
