...
SRC_URI = "https://github.com/ros2-gbp/fastrtps-release/archive/release/dashing/fastrtps/1.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "be7ced8d016b55d31fc6a5f0fefff32b"
SRC_URI[sha256sum] = "a5e44a0afc899b684cfe25d4f9f08bbc0b0ef0a124ba19a4a2dc551102e38c2a"
S = "${WORKDIR}/fastrtps-release-release-dashing-fastrtps-1.8.0-1"
