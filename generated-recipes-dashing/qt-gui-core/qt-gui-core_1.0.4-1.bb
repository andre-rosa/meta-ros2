...
SRC_URI = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/dashing/qt_gui_core/1.0.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2332e22b013efa7b1ce5937d41e9ee78"
SRC_URI[sha256sum] = "0d6ed3bca7628e0cf2492bd557b6b11a5f9bdb7ab7c6b196c60265fb5e6cb02a"
S = "${WORKDIR}/qt_gui_core-release-release-dashing-qt_gui_core-1.0.4-1"
