...
SRC_URI = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/dashing/qt_gui/1.0.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5fe5890ac037ec245594986154d1c671"
SRC_URI[sha256sum] = "c3a0ca7df1d0c75892842ab5b810304ad98b3344d1588a5db80461e0867f2306"
S = "${WORKDIR}/qt_gui_core-release-release-dashing-qt_gui-1.0.4-1"
