...
SRC_URI = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/dashing/qt_dotgraph/1.0.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4a3b813c97967a0af4f25f5a5fef1aee"
SRC_URI[sha256sum] = "6db67264338a9b475b4ae7424cd5938906551a69dfc07084344a7a1a3deaa5cf"
S = "${WORKDIR}/qt_gui_core-release-release-dashing-qt_dotgraph-1.0.4-1"
