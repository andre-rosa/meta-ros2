...
SRC_URI = "https://github.com/ros2-gbp/rcl-release/archive/release/dashing/rcl_lifecycle/0.7.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "60ffdd6146f64c2d3b6af4afce623f34"
SRC_URI[sha256sum] = "7749b6dbd66c12bfdeea95f2972458ff3d5b26ed3cee5a911bfc02a70c2db295"
S = "${WORKDIR}/rcl-release-release-dashing-rcl_lifecycle-0.7.3-1"
