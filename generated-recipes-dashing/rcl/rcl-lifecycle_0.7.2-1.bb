...
SRC_URI = "https://github.com/ros2-gbp/rcl-release/archive/release/dashing/rcl_lifecycle/0.7.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f95e9ee9e6fae5a7092da9e7d31c6235"
SRC_URI[sha256sum] = "e32ecf7313cab95cc21148a2598c5965ca91795c4e77a4e18ddffe06c01d7e69"
S = "${WORKDIR}/rcl-release-release-dashing-rcl_lifecycle-0.7.2-1"
