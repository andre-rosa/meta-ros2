...
SRC_URI = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/dashing/rosidl_runtime_py/0.7.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "1f1972178beaeb50e69f92cac56de4fb"
SRC_URI[sha256sum] = "7d00f191145a45dd2afc64e8eeee00a34ac80b48210210f10afb0e8210182929"
S = "${WORKDIR}/rosidl_python-release-release-dashing-rosidl_runtime_py-0.7.3-1"
