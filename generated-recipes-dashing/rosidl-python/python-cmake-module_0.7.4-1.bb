...
SRC_URI = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/dashing/python_cmake_module/0.7.4-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "871281d1a56d9779dc93306d5de28139"
SRC_URI[sha256sum] = "26669060e23554e2fb30deb3a582101193a21ed0d6b28521d0e0a1b256cc5fe0"
S = "${WORKDIR}/rosidl_python-release-release-dashing-python_cmake_module-0.7.4-1"
