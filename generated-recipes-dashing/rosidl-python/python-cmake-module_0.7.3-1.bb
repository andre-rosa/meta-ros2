...
SRC_URI = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/dashing/python_cmake_module/0.7.3-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f955a063272b0064d4f258ada8d8d468"
SRC_URI[sha256sum] = "ac0c4b62a05ac1bf2cf666f422e05551b371558d839a2722c0121585d5e591e3"
S = "${WORKDIR}/rosidl_python-release-release-dashing-python_cmake_module-0.7.3-1"
