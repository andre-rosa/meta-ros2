...
SRC_URI = "https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/dashing/gazebo_ros_pkgs/3.3.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "973b58eed27d7f8c3208927e3cf4b160"
SRC_URI[sha256sum] = "1ca1f7d0455c9d020b55ffd59c5858d2141ce6628eefe7a45910c132047f3f45"
S = "${WORKDIR}/gazebo_ros_pkgs-release-release-dashing-gazebo_ros_pkgs-3.3.0-1"
