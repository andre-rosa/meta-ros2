...
SRC_URI = "https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/dashing/gazebo_ros/3.3.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e8fc56cbf7c8ca4d6ac0ca04b81f383c"
SRC_URI[sha256sum] = "a48c7ffb7f03051201daa9880439a9d05524c7e5f680a3731bb269772465d574"
S = "${WORKDIR}/gazebo_ros_pkgs-release-release-dashing-gazebo_ros-3.3.0-1"
