...
SRC_URI = "https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/dashing/gazebo_dev/3.3.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "bb2c7bb6b20f4d013f60c97e1f1d191e"
SRC_URI[sha256sum] = "f125c1c205c83fa98cbbd03ac0f32d60cad5990b02f17f7c348eab207b1b2f30"
S = "${WORKDIR}/gazebo_ros_pkgs-release-release-dashing-gazebo_dev-3.3.0-1"
