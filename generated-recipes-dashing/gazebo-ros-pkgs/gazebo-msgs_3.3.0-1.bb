...
SRC_URI = "https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/dashing/gazebo_msgs/3.3.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7e141abe4a40f90415da99c506db117d"
SRC_URI[sha256sum] = "1d3818d187eb158113b20621901f183bd1b8fdd931c86339e64ce9c718e201fe"
S = "${WORKDIR}/gazebo_ros_pkgs-release-release-dashing-gazebo_msgs-3.3.0-1"
