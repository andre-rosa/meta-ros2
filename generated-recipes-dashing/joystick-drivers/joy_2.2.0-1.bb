...
SRC_URI = "https://github.com/ros2-gbp/joystick_drivers-release/archive/release/dashing/joy/2.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "322733fec0f0e30ed0b18ddfd13f798d"
SRC_URI[sha256sum] = "13aebb22d081850223aee1302bdc180f67a2279b4ca5196665887080f8ce7a21"
S = "${WORKDIR}/joystick_drivers-release-release-dashing-joy-2.2.0-1"
