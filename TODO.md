...
- Add downloadfilename parameter:
        ...
        recipes-devtools/python/python-wstool_0.1.17.bb:7:SRC_URI = "http://download.ros.org/downloads/wstool/wstool-${PV}.tar.gz"
        recipes-devtools/python/python-vcstools_0.1.40.bb:7:SRC_URI = "http://download.ros.org/downloads/vcstools/vcstools-${PV}.tar.gz"
        recipes-devtools/python/python-rosinstall_0.7.8.bb:9:SRC_URI = "http://download.ros.org/downloads/rosinstall/rosinstall-${PV}.tar.gz"
